        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
              Pain itself, it is pain, but it is extremely important. It is pure invention itself for the pleasure of being rational, except for some advantages, to choose the great option.
              </p>
              <div>
